...
};gdjs.Percurso_32MonopolyCode.userFunc0x136e4d0 = function GDJSInlineCode(runtimeScene) {
"use strict";
...
gdjs.Percurso_32MonopolyCode.userFunc0x136e540 = function GDJSInlineCode(runtimeScene) {
"use strict";
...
{runtimeScene.getGame().getVariables().getFromIndex(2).setNumber(9);
    ...
    gdjs.Percurso_32MonopolyCode.GDURLObjects1[i].setString("https://www.google.pt/maps/place/R.+do+Carmo+3,+1200-092+Lisboa/@38.7110588,-9.1403791,19z/data=!3m1!4b1!4m6!3m5!1s0xd193478d1503115:0x49671aea238a34e4!8m2!3d38.7110578!4d-9.1397354!16s%2Fg%2F11csms1vss?entry=ttu&g_ep=EgoyMDI1MDYxMS4wIKXMDSoASAFQAw%3D%3D");
}
}{runtimeScene.getScene().getVariables().getFromIndex(0).setNumber(38.7106);
}{runtimeScene.getScene().getVariables().getFromIndex(1).setNumber(38.7114);
}{runtimeScene.getScene().getVariables().getFromIndex(2).setNumber(-(9.1392));
}{runtimeScene.getScene().getVariables().getFromIndex(3).setNumber(-(9.1400));
}}
...
gdjs.Percurso_32MonopolyCode.userFunc0x136e4d0(runtimeScene);
...
gdjs.Percurso_32MonopolyCode.userFunc0x136e540(runtimeScene);

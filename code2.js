...
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(10424972);
}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(10438892);
}
if (isConditionTrue_0) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(10469956);
}
if (isConditionTrue_0) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(10472220);
}
if (isConditionTrue_0) {
...
}{gdjs.evtTools.firebaseTools.database.updateField(gdjs.evtTools.firebaseTools.auth.userManagement.getUID(), "Language", runtimeScene.getGame().getVariables().getFromIndex(8).getAsString(), runtimeScene.getScene().getVariables().getFromIndex(10));
...
if (isConditionTrue_0) {
{gdjs.evtTools.firebaseTools.database.updateField("UID", "Amarela_Preta", gdjs.evtTools.firebaseTools.auth.userManagement.getUID(), runtimeScene.getScene().getVariables().getFromIndex(10));
}}
...
if (isConditionTrue_0) {
{gdjs.evtTools.firebaseTools.database.updateField("UID", "Azul_Preta", gdjs.evtTools.firebaseTools.auth.userManagement.getUID(), runtimeScene.getScene().getVariables().getFromIndex(10));
}}
...
if (isConditionTrue_0) {
{gdjs.evtTools.firebaseTools.database.updateField("UID", "Branca_Preta", gdjs.evtTools.firebaseTools.auth.userManagement.getUID(), runtimeScene.getScene().getVariables().getFromIndex(10));
}}
...
if (isConditionTrue_0) {
{gdjs.evtTools.firebaseTools.database.updateField("UID", "Roxa_Preta", gdjs.evtTools.firebaseTools.auth.userManagement.getUID(), runtimeScene.getScene().getVariables().getFromIndex(10));
}}
...
if (isConditionTrue_0) {
{gdjs.evtTools.firebaseTools.database.updateField("UID", "VerdeClara_Preta", gdjs.evtTools.firebaseTools.auth.userManagement.getUID(), runtimeScene.getScene().getVariables().getFromIndex(10));
}}
...
if (isConditionTrue_0) {
{gdjs.evtTools.firebaseTools.database.updateField("UID", "Verde_Preta", gdjs.evtTools.firebaseTools.auth.userManagement.getUID(), runtimeScene.getScene().getVariables().getFromIndex(10));
}}
...
if (isConditionTrue_0) {
{gdjs.evtTools.firebaseTools.database.updateField("UID", "AzulClara_Preta", gdjs.evtTools.firebaseTools.auth.userManagement.getUID(), runtimeScene.getScene().getVariables().getFromIndex(10));
}}
...
if (isConditionTrue_0) {
{gdjs.evtTools.firebaseTools.database.updateField("UID", "Vermelha_Preta", gdjs.evtTools.firebaseTools.auth.userManagement.getUID(), runtimeScene.getScene().getVariables().getFromIndex(10));
}}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(10503236);
}
if (isConditionTrue_0) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(10506796);
}
if (isConditionTrue_0) {
{gdjs.evtTools.sound.playSound(runtimeScene, "wrong-47985.mp3", false, 100, 1);
}}
...
isConditionTrue_0 = false;
{
{isConditionTrue_1 = (runtimeScene.getScene().getVariables().getFromIndex(3).getAsString() == "2101");
}
if(isConditionTrue_1) {
    isConditionTrue_0 = true;
}
...
{
{isConditionTrue_1 = (runtimeScene.getScene().getVariables().getFromIndex(3).getAsString() == "2202");
}
if(isConditionTrue_1) {
    isConditionTrue_0 = true;
}
...
{
{isConditionTrue_1 = (runtimeScene.getScene().getVariables().getFromIndex(3).getAsString() == "2303");
}
if(isConditionTrue_1) {
    isConditionTrue_0 = true;
}
...
{
{isConditionTrue_1 = (runtimeScene.getScene().getVariables().getFromIndex(3).getAsString() == "2404");
}
if(isConditionTrue_1) {
    isConditionTrue_0 = true;
}
...
{
{isConditionTrue_1 = (runtimeScene.getScene().getVariables().getFromIndex(3).getAsString() == "2505");
}
if(isConditionTrue_1) {
    isConditionTrue_0 = true;
}
...
{
{isConditionTrue_1 = (runtimeScene.getScene().getVariables().getFromIndex(3).getAsString() == "2606");
}
if(isConditionTrue_1) {
    isConditionTrue_0 = true;
}
...
{
{isConditionTrue_1 = (runtimeScene.getScene().getVariables().getFromIndex(3).getAsString() == "2707");
}
if(isConditionTrue_1) {
    isConditionTrue_0 = true;
}
...
{
{isConditionTrue_1 = (runtimeScene.getScene().getVariables().getFromIndex(3).getAsString() == "2808");
}
if(isConditionTrue_1) {
    isConditionTrue_0 = true;
}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(10513740);
}
if (isConditionTrue_0) {
{gdjs.evtTools.sound.playSound(runtimeScene, "wrong-47985.mp3", false, 100, 1);
}}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = (runtimeScene.getScene().getVariables().getFromIndex(3).getAsString() == "2101");
}
}
if (isConditionTrue_0) {
{gdjs.evtTools.firebaseTools.database.hasVariable("UID/Amarela_Preta", runtimeScene.getScene().getVariables().getFromIndex(4), runtimeScene.getScene().getVariables().getFromIndex(10));
}}
...
if (isConditionTrue_0) {
{gdjs.evtTools.firebaseTools.database.getField("UID", "Amarela_Preta", runtimeScene.getScene().getVariables().getFromIndex(14), runtimeScene.getScene().getVariables().getFromIndex(10));
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = (runtimeScene.getScene().getVariables().getFromIndex(3).getAsString() == "2202");
}
}
if (isConditionTrue_0) {
{gdjs.evtTools.firebaseTools.database.hasVariable("UID/Azul_Preta", runtimeScene.getScene().getVariables().getFromIndex(5), runtimeScene.getScene().getVariables().getFromIndex(10));
}}
...
if (isConditionTrue_0) {
{gdjs.evtTools.firebaseTools.database.getField("UID", "Azul_Preta", runtimeScene.getScene().getVariables().getFromIndex(14), runtimeScene.getScene().getVariables().getFromIndex(10));
}{gdjs.evtTools.runtimeScene.unpauseTimer(runtimeScene, "next scene");
}}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = (runtimeScene.getScene().getVariables().getFromIndex(3).getAsString() == "2303");
}
}
if (isConditionTrue_0) {
{gdjs.evtTools.firebaseTools.database.hasVariable("UID/Branca_Preta", runtimeScene.getScene().getVariables().getFromIndex(6), runtimeScene.getScene().getVariables().getFromIndex(10));
}}
...
if (isConditionTrue_0) {
{gdjs.evtTools.firebaseTools.database.getField("UID", "Branca_Preta", runtimeScene.getScene().getVariables().getFromIndex(14), runtimeScene.getScene().getVariables().getFromIndex(10));
}{gdjs.evtTools.runtimeScene.unpauseTimer(runtimeScene, "next scene");
}}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = (runtimeScene.getScene().getVariables().getFromIndex(3).getAsString() == "2404");
}
}
if (isConditionTrue_0) {
{gdjs.evtTools.firebaseTools.database.hasVariable("UID/Roxa_Preta", runtimeScene.getScene().getVariables().getFromIndex(7), runtimeScene.getScene().getVariables().getFromIndex(10));
}}
...
if (isConditionTrue_0) {
{gdjs.evtTools.firebaseTools.database.getField("UID", "Roxa_Preta", runtimeScene.getScene().getVariables().getFromIndex(14), runtimeScene.getScene().getVariables().getFromIndex(10));
}{gdjs.evtTools.runtimeScene.unpauseTimer(runtimeScene, "next scene");
}}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = (runtimeScene.getScene().getVariables().getFromIndex(3).getAsString() == "2505");
}
}
if (isConditionTrue_0) {
{gdjs.evtTools.firebaseTools.database.hasVariable("UID/VerdeClara_Preta", runtimeScene.getScene().getVariables().getFromIndex(8), runtimeScene.getScene().getVariables().getFromIndex(10));
}}
...
if (isConditionTrue_0) {
{gdjs.evtTools.firebaseTools.database.getField("UID", "VerdeClara_Preta", runtimeScene.getScene().getVariables().getFromIndex(14), runtimeScene.getScene().getVariables().getFromIndex(10));
}{gdjs.evtTools.runtimeScene.unpauseTimer(runtimeScene, "next scene");
}}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = (runtimeScene.getScene().getVariables().getFromIndex(3).getAsString() == "2606");
}
}
if (isConditionTrue_0) {
{gdjs.evtTools.firebaseTools.database.hasVariable("UID/Verde_Preta", runtimeScene.getScene().getVariables().getFromIndex(0), runtimeScene.getScene().getVariables().getFromIndex(10));
}}
...
if (isConditionTrue_0) {
{gdjs.evtTools.firebaseTools.database.getField("UID", "Verde_Preta", runtimeScene.getScene().getVariables().getFromIndex(14), runtimeScene.getScene().getVariables().getFromIndex(10));
}{gdjs.evtTools.runtimeScene.unpauseTimer(runtimeScene, "next scene");
}}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = (runtimeScene.getScene().getVariables().getFromIndex(3).getAsString() == "2707");
}
}
if (isConditionTrue_0) {
{gdjs.evtTools.firebaseTools.database.hasVariable("UID/AzulClara_Preta", runtimeScene.getScene().getVariables().getFromIndex(2), runtimeScene.getScene().getVariables().getFromIndex(10));
}}
...
if (isConditionTrue_0) {
{gdjs.evtTools.firebaseTools.database.getField("UID", "AzulClara_Preta", runtimeScene.getScene().getVariables().getFromIndex(14), runtimeScene.getScene().getVariables().getFromIndex(10));
}{gdjs.evtTools.runtimeScene.unpauseTimer(runtimeScene, "next scene");
}}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = (runtimeScene.getScene().getVariables().getFromIndex(3).getAsString() == "2808");
}
}
if (isConditionTrue_0) {
{gdjs.evtTools.firebaseTools.database.hasVariable("UID/Vermelha_Preta", runtimeScene.getScene().getVariables().getFromIndex(1), runtimeScene.getScene().getVariables().getFromIndex(10));
}}
...
if (isConditionTrue_0) {
{gdjs.evtTools.firebaseTools.database.getField("UID", "Vermelha_Preta", runtimeScene.getScene().getVariables().getFromIndex(14), runtimeScene.getScene().getVariables().getFromIndex(10));
}{gdjs.evtTools.runtimeScene.unpauseTimer(runtimeScene, "next scene");
}}
